...
// ==============================================================
#ifndef __CNN_mac_muladd_7nbkb__HH__
#define __CNN_mac_muladd_7nbkb__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(CNN_mac_muladd_7nbkb) {
    ...
    SC_CTOR(CNN_mac_muladd_7nbkb):  simcore_mac_0_U ("simcore_mac_0_U") {
