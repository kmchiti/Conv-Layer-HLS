...
// ==============================================================
#ifndef __CNN_mac_muladd_4ndEe__HH__
#define __CNN_mac_muladd_4ndEe__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(CNN_mac_muladd_4ndEe) {
    ...
    SC_CTOR(CNN_mac_muladd_4ndEe):  simcore_mac_2_U ("simcore_mac_2_U") {
